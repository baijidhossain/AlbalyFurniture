...
class HomeController extends Controller
{
  ...
  public function default_theme()
  {
    ...
    $categories = $this->category->with('childes.childes')->where(['position' => 0])->priority()->take(6)->get();
  ...
  public function theme_aster()
  {
    ...
    $categories = Category::with('childes.childes')->where(['position' => 0])->priority()->take(6)->get();
