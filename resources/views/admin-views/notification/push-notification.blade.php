    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder text-capitalize">
                ...
                <div class="ripple-animation" data-toggle="modal" data-bs-target="#docsModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-3">
                        <button type="button" class="btn btn--primary min-w-120 px-5" data-bs-dismiss="modal">{{translate('ok')}}</button>
                        <button type="button" class="btn btn-danger-light min-w-120 px-5" data-bs-dismiss="modal">{{translate('cancel')}}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body px-4 px-sm-5 pt-0">
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="mx-auto w-100 max-w-300">
                            <button class="btn btn--primary btn-block" data-bs-dismiss="modal">{{translate('got_it')}}</button>
                        </div>
                    </div>
                </div>
            </div>
