<div class="modal-header p-2">
    ...
    <button class="radius-50 border-0 font-weight-bold text-black-50" type="button" data-bs-dismiss="modal" aria-label="Close">
                        ...
                        <div class="d-flex flex-column gap-1 mt-3 title-color" id="chosen_price_div">
                            ...
                            <div class="product-price c1">
                                ...
                                <span class="text-muted fz-10">
                                    ( {{ translate('tax') }} <span class="product-tax-show">{{ $product->tax_model == 'include' ? 'incl.' : \App\CPU\Helpers::currency_converter($product->tax)}}</span> )</span>
                            </div>
                        </div>
                    </div>
