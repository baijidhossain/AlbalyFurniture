...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3 mb-3">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder text-capitalize">
                ...
                <div class="ripple-animation" data-bs-toggle="modal" data-bs-target="#readInstructionsModal">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.business-settings.web-config.app-settings-update') }}" method="post">
                    @csrf
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            @php
                                $user_app_version_control = $user_app_version_control ? json_decode($user_app_version_control['value'], true) : [];
                                $seller_app_version_control = $seller_app_version_control ? json_decode($seller_app_version_control['value'], true) : [];
                                $delivery_man_app_version_control = $delivery_man_app_version_control ? json_decode($delivery_man_app_version_control['value'], true) : [];
                            @endphp
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="for_android[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $user_app_version_control['for_android']['version'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="for_ios[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $user_app_version_control['for_ios']['version'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="for_android[status]" value="1">
                                    <input type="text" class="form-control" name="for_android[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $seller_app_version_control['for_android']['version'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="for_ios[status]" value="1">
                                    <input type="text" class="form-control" name="for_ios[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $seller_app_version_control['for_ios']['version'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="for_android[status]" value="1">
                                    <input type="text" class="form-control" name="for_android[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $delivery_man_app_version_control['for_android']['version'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="for_android[status]" value="1">
                                    <input type="text" class="form-control" name="for_ios[version]" placeholder="{{translate('ex: 2.1')}}" required value="{{ $delivery_man_app_version_control['for_ios']['version'] ?? '' }}">
                                </div>
    ...
    <!-- Read Instruction Modal -->
    <div class="modal fade" id="readInstructionsModal" tabindex="-1" aria-labelledby="readInstructionsModal" aria-hidden="true">
