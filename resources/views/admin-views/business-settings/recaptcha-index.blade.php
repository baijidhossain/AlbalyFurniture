                                ...
                                <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between">
                                    ...
                                    <div class="position-relative">
                                        <label class="switcher">
                                            ...
                                            onclick="toogleStatusModal(event,'recaptcha_id','recaptcha-off.png','recaptcha-off.png',
                                            '{{translate('important')}}!','{{translate('warning')}}!',
                                             `<p>{{translate('reCAPTCHA_is_now_enabled_for_added_security.Users_may_be_prompted_to_complete_a_reCAPTCHA_challenge_to_verify_their_human_identity_and protect_against_spam_and_malicious_activity')}}</p>`,
                                             `<p>{{translate('disabling_reCAPTCHA_may_leave_your_website_vulnerable_to_spam_and_malicious_activity_and_suspects_that_a_user_may_be_a_bot').' '.translate('it_is_highly_recommended_to_keep_reCAPTCHA_enabled_to_ensure_the_security_and_integrity_of_your_website')}}</p>`)"
                                             id="recaptcha_id" {{$config['status']==1?'checked':''}} value="1">
