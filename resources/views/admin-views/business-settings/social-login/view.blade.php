                            ...
                            <form
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center gap-2">
                                        <img width="16" src="{{asset('/public/assets/back-end/img')}}/{{$socialLoginService['login_medium']}}{{('-logo.png')}}" alt="">
                                    ...
                                    <label class="switcher">
                                        ...
                                        onclick="toogleStatusModal(event,'{{$socialLoginService['login_medium']}}_id','social/{{$socialLoginService['login_medium']}}-on.png','social/{{$socialLoginService['login_medium']}}-off.png',
                                        '{{translate('want_to_turn_ON_'.$socialLoginService['login_medium'].'_login')}}?','{{translate('want_to_turn_OFF_'.$socialLoginService['login_medium'].'_login')}}?',
                                        `<p>{{translate('if_enabled_customers_can_log_in_to_their_account_using_their'.' '.$socialLoginService['login_medium'].' '.'credentials')}}</p>`,
                                        `<p>{{translate('if_disabled_customers_cannot_log_in_to_their_account_using_their'.' '.$socialLoginService['login_medium'].' '.'credentials')}}</p>`)"
                                         id="{{$socialLoginService['login_medium']}}_id" value="1" {{isset($socialLoginService['status']) && $socialLoginService['status'] == 1 ?'checked' : ''}}>                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control d-flex align-items-center justify-content-between py-1 pl-3 pr-2">
                                            ...
                                            <span class="btn-link" onclick="copyToClipboard('#id_{{$socialLoginService['login_medium']}}')">
                                                <i class="tio-copy"></i>
                                                {{-- {{translate('copy_URI')}} --}}
                                            </span>
                                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card overflow-hidden">
                            <form
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center gap-2">
                                        <img width="16" src="{{asset('/public/assets/back-end/img/apple.png')}}" alt="">
                                        <h4 class="mb-0">{{translate($appleLoginService['login_medium'])}} {{translate('login')}}</h4>
                                    </div>

                                    <label class="switcher">
                                        <input class="switcher_input" type="checkbox"
                                        onclick="toogleStatusModal(event,'apple_login_id','social/apple-on.png','social/apple-off.png',
                                        '{{translate('want_to_turn_ON_apple_login')}}?','{{translate('want_to_turn_OFF_apple_login')}}?',
                                        `<p>{{translate('if_enabled_customers_can_log_in_to_their_account_using_their_Apple_credentials')}}</p>`,
                                        `<p>{{translate('if_disabled_customers_cannot_log_in_to_their_account_using_their_Apple_credentials')}}</p>`)"
                                        id="apple_login_id"{{$appleLoginService['status']==1?'checked':''}} value="1" name="status">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-file">
                                            <input type="file" name="service_file" class="custom-file-input form-control" required="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="d-flex gap-3 flex-column align-items-center text-center mb-4">
                            <img width="80" src="{{asset('/public/assets/back-end/img/google-logo.png')}}" alt="">
        ...
        <div class="modal fade" id="facebook-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="d-flex gap-3 flex-column align-items-center text-center mb-4">
                            <img width="80" src="{{asset('/public/assets/back-end/img/facebook.png')}}" alt="">
                            <h5 class="modal-title" id="staticBackdropLabel">{{translate('facebook_API_Set_up_Instructions')}}</h5>
                        </div>
        ...
        <div class="modal fade" id="apple-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    ...
                    <div class="modal-body pt-0">
                        <div class="d-flex gap-3 flex-column align-items-center text-center mb-4">
                            <img width="80" src="{{asset('/public/assets/back-end/img/apple.png')}}" alt="">
