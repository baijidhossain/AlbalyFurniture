                ...
                <div class="card-body">
                    <div class="row gy-2">
                        ...
                        <div class="col-sm-8 col-md-4 col-lg-6">
                            ...
                            <div >{{translate('QTY')}} : {{$refund->order_details->qty}}</div>
                            <div>{{translate('price')}} : {{\App\CPU\Helpers::currency_converter($refund->order_details->price)}}</div>
                ...
                <div class="card-body">
                    <div class="row gy-2">
                        ...
                        <div class="col-sm-6 col-md-4 d-flex flex-column gap-10">
                            ...
                            <span>{{translate('order_details')}} : <a class="btn btn--primary btn-sm" href="{{route('seller.orders.details',['id'=>$order->id])}}">{{translate('click_here')}}</a></span>
                        </div>
                    </div>
                </div>
            </div>
