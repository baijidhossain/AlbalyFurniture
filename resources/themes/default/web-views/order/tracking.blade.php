    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-0">
          ...
          <div class="table-responsive">
            <table class="table __table text-start">
              <thead class="mb-3">
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <div class="d-flex media align-items-center gap-3">
                      ...
                      <div>
                        ...
                        @if($order_details->product && $orderDetails->payment_status == 'paid' &&
                        $order_details->product->digital_product_type == 'ready_product')
                        <a onclick="digital_product_download('{{ route('digital-product-download', $order_details->id) }}')"
                          href="javascript:" class="btn btn-success btn-sm" data-toggle="tooltip"
                          data-placement="bottom" title="{{translate('download')}}">
                          <i class="fa fa-download"></i>
                        </a>
                        @elseif($order_details->product && $orderDetails->payment_status == 'paid' &&
                        $order_details->product->digital_product_type == 'ready_after_sell')
                        @if($order_details->digital_file_after_sell)
                        <a onclick="digital_product_download('{{ route('digital-product-download', $order_details->id) }}')"
                          href="javascript:" class="btn btn-success btn-sm" data-bs-toggle="tooltip"
                          data-placement="bottom" title="{{translate('download')}}">
                          <i class="fa fa-download"></i>
                        </a>
                        @else
                        <span class="btn btn-success disabled" data-bs-toggle="tooltip" data-bs-placement="top"
    ...
    <div class="col-md-10">
      ...
      <div class="card my-5">
        ...
        <div class="card-header">
          <h2 class="card-title">{{ translate('track_order')}}</h2>
        </div>
        ...
        <div class="card-body">
          ...
          <h6 class="font-weight-bold text-center my-3">
           {{ translate('your_order')}}  : <span class="text-bold">{{$orderDetails['id']}}</span> 
          </h6>

          <ul class="nav nav-justified order-track-info">
                ...
                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                  ...
                  <div class="media-body">
                    <div class="text-sm-center">
                      <h6 class="media-tab-title text-nowrap mb-0 text-capitalize fs-14">{{ translate('order_placed')}}
                      </h6>
                    </div>
              ...
              <div
                ...
                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                  ...
                  <div class="media-body">
                    ...
                    @if(($orderDetails['order_status']=='confirmed') || ($orderDetails['order_status']=='processing') ||
                    ($orderDetails['order_status']=='processed') || ($orderDetails['order_status']=='out_for_delivery')
                    || ($orderDetails['order_status']=='delivered') &&
                    \App\CPU\order_status_history($orderDetails['id'],'confirmed'))
              ...
              <div
                ...
                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                  ...
                  <div class="media-body">
                    <div class="text-sm-center">
                      <h6 class="media-tab-title text-nowrap mb-0 text-capitalize fs-14">
                        {{ translate('preparing_shipment')}}</h6>
                    </div>
                    @if( ($orderDetails['order_status']=='processing') || ($orderDetails['order_status']=='processed')
                    || ($orderDetails['order_status']=='out_for_delivery') ||
                    ($orderDetails['order_status']=='delivered') &&
                    \App\CPU\order_status_history($orderDetails['id'],'processing'))
                ...
                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                  ...
                  <div class="media-body">
                    ...
                    <div class="d-flex align-items-center justify-content-sm-center mt-1">
                      <img class="mx-sm-1" src="{{asset('/public/assets/front-end/img/track-order/clock.png')}}"
                        width="20" alt="">
                    ...
                    <div class="mt-1">
                      <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                        <span class="text-muted fs-14 text-capitalize">{{translate('delivery_service_name')}} : </span>
                        <span class="fs-14 fw-semibold text-dark">{{$orderDetails->delivery_service_name}}</span>
                      </span>
                      <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                    ...
                    <div class="mt-1">
                      <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                        <span class="text-muted fs-14 text-capitalize">{{translate('delivery_man_name')}} : </span>
                        <span
              ...
              <div class="nav-link {{($orderDetails['order_status']=='delivered')?'active-status' : ''}}">
                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                  ...
                  <div class="media-body">
                    ...
                    \App\CPU\order_status_history($orderDetails['id'],'delivered'))
                    <div class="d-flex align-items-center justify-content-sm-center mt-2 gap-2">
                      <img src="{{asset('/public/assets/front-end/img/track-order/clock.png')}}" width="14" alt="">
                      <span class="text-muted fs-12">
        ...
        <div class="card-footer bg-white border-0">
          <div class="text-center mb-4">
            <a class="btn btn--primary" href="#order-details"
              data-bs-toggle="modal">{{ translate('view_order_details')}}</a>
          </div>
        </div>
