            ...
            <form action="{{route('track-order.result')}}" type="submit" method="post" class="p-3">
              ...
              <div class="row g-3">
                <div class="col-md-4 col-sm-6">
                  <input class="form-control prepended-form-control" type="text" value="{{ old('order_id') }}"
                    name="order_id" placeholder="{{translate('order_id')}}" required>
                </div>
                <div class="col-md-4 col-sm-6">
                  <input class="form-control prepended-form-control" type="text" value="{{ old('phone_number') }}"
                    name="phone_number" placeholder="{{translate('your_phone_number')}}" required>
                </div>
                <div class="col-md-4">
