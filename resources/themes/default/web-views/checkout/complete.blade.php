      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="mb-3 text-center">
              <img src="{{ asset("public/assets/front-end/img/icons/payment_check.svg") }}" width="80">
          </div>

          <h3 class="font-black fw-bold text-center ">{{ translate('order_Placed_Successfully')}}!</h3>
          ...
          @else
          <p class="text-center fs-12">{{ translate('your_order_is_being_processed_and_will_be_completed.') }}
            {{ translate('You_will_receive_an_email_confirmation_when_your_order_is_placed.') }}</p>
          @endif
