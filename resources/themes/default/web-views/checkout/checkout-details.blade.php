...
@section('title',translate('Checkout_Process_Start'))
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="email" name="email"
                                                               ...
                                                               required>
                                                        <div class="invalid-feedback">{{ translate('please_provide_a_valid_email_address')}}.
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="invalid-feedback">{{ translate('please_fill_in_your_first_name.')}}</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="invalid-feedback">{{ translate('please_fill_in_your_last_name.')}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="email" type="email"
                                                               ...
                                                               placeholder="johndoe@example.com"
                                                               required>
                                                        <div class="invalid-feedback">{{ translate('please_provide_a_valid_email_address.')}}</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
