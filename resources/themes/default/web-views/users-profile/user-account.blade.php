...
@section('content')
                ...
                <div class="card">
                      ...
                      <div class="card-header py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2">
                          ...
                          <h5 class="mb-0">{{translate('profile_Info')}}</h5>
                          ...
                          <div class="text-end d-none d-lg-block">
                            <div class="dropdown">
                              <button class="btn border border-base px-2 py-1" type="button" data-bs-toggle="dropdown">
                                <i class="ri-more-2-fill"></i>
                              </button>
                              <div class="dropdown-menu" style="width:200px;min-width:0 !important">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                            <form class="mt-3 px-sm-2 pb-2" action="{{route('user-update')}}" method="post" id="profile_form"
    ...
    <div class="bottom-sticky_ele bg-white d-md-none p-3 ">
        <button type="submit" class="btn btn--primary w-100 update_submit" onclick="update_profile()">
            {{translate('update')}}
        </button>
    </div>
