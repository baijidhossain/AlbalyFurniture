        ...
        @include('web-views.partials._profile-aside')
            ...
            <section class="col-lg-9 __customer-profile">
                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                    <h5 class="mb-0">{{translate('loyalty_point')}}</h5>
                ...
                @endphp
                <div class="card __card loyalty-card mb-10px">
                    <div class="card-body">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="how-to-use-hover-ele">
                                    ...
                                    <ul class='pl-4 fs-12'>
                                        ...
                                        <li>
                                            {{translate('minimum')}} {{App\CPU\Helpers::get_business_settings('loyalty_point_minimum_point')}} {{translate('points_required_to_convert_into_currency')}}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card btn--primary h-100 position-relative">
                                    <div class="card-body d-flex align-items-center z-2">
                                        <div class="d-flex flex-wrap gap-8 justify-content-between align-items-center w-100">
                                            <div class="text-white">
                                                <p class="mb-2">{{translate('Total Loyalty Point')}}</p>
                ...
                <div class="card __card loyalty-card">
                    <div class="card-header border-0 gap-2 d-flex flex-column flex-sm-row align-items-center justify-content-between">
                        <h5 class="mb-0 font-bold">{{ translate('Transaction_History') }}</h5>
                        <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                            <div class="dropdown border rounded">
                                <button class="btn btn-sm pl-3 dropdown-toggle" type="button" id="dropdownMenuButton"
                                    ...
                                    {{ translate('filter')}} : {{ request()->has('type') ? ucwords(translate(request('type'))):translate('all')}}
                                </button>
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="bg--light my-1 p-3 p-sm-3 rounded d-flex justify-content-between g-2">
                                <div class="">
                                    ...
                                    <h6 class="text-muted text-capitalize mb-0 fs-13">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title flex-grow-1 text-center" id="exampleModalLongTitle">{{translate('Convert point to wallet money')}}</h5>
        ...
        <div class="modal-body py-sm-5">
            <div class="px-sm-5">
                ...
                <div class="form-group">
                    <input class="form-control text-center fz-30" type="number" id="city" name="point" required>
                </div>
                ...
                <div class="my-wallet-card-content text-break-word">
                    <h6 class="subtitle text-capitalize text-primary">{{translate('Note')}}</h6>
                    <ul>
                        <li>
                            {{translate('convert_your_loyalty_point_to_wallet_money')}}.
                        </li>
                ...
                <button type="submit" class="btn btn--primary w-100 mt-5">{{translate('submit')}}</button>
            </div>
        </div>
    </form>
      </div>
