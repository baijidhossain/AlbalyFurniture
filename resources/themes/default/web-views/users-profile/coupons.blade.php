                ...
                <div class="card __card">
                  ...
                  <div class="card-header pt-4 pb-0">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                      <h5 class="mb-0">{{translate('coupons')}}</h5>
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-lg-6">
                        <div class="ticket-box">
                          ...
                          <div class="ticket-end">
                            <button class="ticket-welcome-btn couponid couponid-{{ $item->code }}"
                              onclick="click_to_copy_coupon('{{ $item->code }}')">{{ $item->code }}</button>
                            <button
                            ...
                            <p class="m-0">{{ translate('available_from_minimum_purchase') }}
                              {{\App\CPU\Helpers::currency_converter($item->min_purchase)}}</p>
                          </div>
                        </div>
                      </div>
                      @endforeach
                      ...
                      <div class="col-12">
                        <div class="text-center py-5 text-capitalize">
                          <img src="{{asset('public/assets/front-end/img/icons/coupon.svg')}}" alt="" class="mb-4"
                            width="70">
                      ...
                      <div class="col-md-12 mt-2 empty">{{ $coupons->links() }}</div>
                    </div>
                  </div>
