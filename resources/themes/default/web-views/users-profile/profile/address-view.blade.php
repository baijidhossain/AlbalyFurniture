            ...
            <div class="sidebarR col-lg-3">
                ...
                <div class="price_sidebar rounded-lg box-shadow-sm __mb-n-10" id="shop-sidebar">
                    ...
                    <div class="pb-0 __pt-12">
                        ...
                        <div class="sidebarL">
                            <h3 class="widget-title btnF font-bold">
                                <a href="{{ route('orderList') }}" class="__color-1B7FED">{{translate('my_Orders')}}</a>
                            </h3>
                    ...
                    <div class="pb-0 __pt-12">
                        <!-- Filter by price-->
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF font-bold"><a href=""> {{translate('chat_with_sellers')}} </a>
                            </h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-0 __pt-12">
                        <!-- Filter by price-->
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF font-bold"><a href="">{{translate('address')}} </a></h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-0 __pt-12">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF font-bold"><a
                                    href="{{ route('support-ticket') }}">{{translate('support_ticket')}} </a></h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-0 __pt-12">
                        <!-- Filter by price-->
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF font-bold"><a href="">{{translate('transaction_history')}} </a>
                            </h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-1 __pt-12">
                        <!-- Filter by price-->
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF font-bold"><a href="">{{translate('payment_method')}} </a></h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="modal-dialog  modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="row">
                                    <div class="col-md-12"><h5 class="modal-title font-nameA ">{{translate('add_a_new_address')}}</h5>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form class="">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="firstName">{{translate('contact_person_name')}}</label>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="closeB" data-bs-dismiss="modal">{{translate('close')}}</button>
                                <button type="button" class="btn btn-p"> {{translate('update_Information')}}</button>
                            </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card cardColor">
                <div class="card-header">
                    ...
                    <span class="namHad">{{translate('permanent_Address')}}</span>
                ...
                <div class="card-body">
                    <div class="font-name"><span> {{translate('Abdur_Rahim')}}</span></div>
                    <div><span class="font-nameA">{{translate('3rd_Floor_D_block')}}</span></div>
                    <div><span class="font-nameA">{{translate('Dhaka_1100')}}</span></div>
        ...
        <div class="col-md-6 div-secon">
            <div class="card cardColor">
                <div class="card-header ">
                    ...
                    <span class="namHad">{{translate('home_Address')}}</span>
                    <span class="float-right iconSp">
                                <i class="fa fa-edit fa-lg"></i>
                                <i class="fa fa-trash fa-lg"></i>
                            </span>
        ...
        <div class="col-md-6">
            <div class="card cardColor">
                <div class="card-header">
                    ...
                    <span class="namHad"> {{translate('office_Address')}}</span>
                    <span class="float-right iconSp">
                            <i class="fa fa-edit fa-lg"></i>
                            <i class="fa fa-trash fa-lg"></i>
                        </span>
