...
@section('content')
    ...
    <div class="container py-4 rtl">
        ...
        <!-- Content  -->
            ...
            <div class="col-lg-9 __customer-profile" >
      
                <div id="set-wish-list">
                      ...
                      <tbody>
                        ...
                        <tr class="text-nowrap">
                          <td class="align-middle">
                              <a class="d-flex gap-2 align-items-center" href="{{ route('account-order-details', ['id'=>$order->id])}}"
                                 class="d-block position-relative">
                                  @if($order->seller_is == 'seller')
                                      <img onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                           src="{{ asset('storage/app/public/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:''))}}"
                                           alt="img/products">
                          ...
                          <td class="align-middle">
                              <a class="text-success-emphasis" href="{{ route('account-order-details', ['id'=>$order->id]) }}" title="{{translate('view_order_details')}}">
                                  <i class="ri-eye-line"></i> {{translate('Details')}}
                              </a>
                      
                              <a class="text-success" href="{{route('generate-invoice',[$order->id])}}" title="{{translate('download_invoice')}}">
                                  <i class="ri-arrow-down-circle-line"></i> {{translate('Download')}}
                              </a>
                          </td>
                      </tr>
                        ...
                        <tr>
                          <td colspan="10" class="text-center">
                            <img src="{{asset('public/assets/front-end/img/icons/order-not-available.svg')}}" alt="" width="70">
