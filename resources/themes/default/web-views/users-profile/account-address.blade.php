...
@push('css')
    ...
    <style>
        ...
        .donate-now li {
            margin: {
                    {
                    Session: :get('direction')==='rtl' ? '0 0 0 5px': '0 5px 0 0'
                }
            }
                        ...
                        <form action="{{ route('address-store') }}" method="post">
                            ...
                            <div class="container">
                                <div class="row my-3">
                                    <div class="col-md-6">
                                        <!-- Nav pills -->
                                        <ul class="donate-now d-flex gap-3 justify-content-start">
                                            <li>
                                    ...
                                    <div class="col-md-6 ">
                                        ...
                                        <ul class="donate-now d-flex justify-content-end  gap-3">
                                            <li>
                                                <input type="radio" name="is_billing" id="b25" value="0"
                                                    checked />
                                                <label for="b25"
                                                    class="billing_component">{{ translate('shipping') }}</label>
                                            </li>
                                            <li>
                                                <input type="radio" name="is_billing" id="b50" value="1" />
                                                <label for="b50"
                                                    class="billing_component">{{ translate('billing') }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn--primary">{{ translate('add_informations') }}
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center mb-3 gap-2">
                                ...
                                <button type="submit" class="btn btn--primary text-capitalize" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" id="add_new_address">
                                    <img src="{{ asset('/public/assets/front-end/img/add-address-icon.png') }}"
                                        class="" alt="">
                        ...
                        <div class="card-body ">
                            ...
                            @if ($shippingAddresses->count() == 0)
                                <div class="text-center text-capitalize pb-5 pt-5">
                                    <img class="mb-4"
                                        src="{{ asset('public/assets/front-end/img/icons/address.svg') }}" alt=""
                                        width="70">
                                ...
                                @foreach ($shippingAddresses as $shippingAddress)
                                    <section class="col-lg-6 col-md-6">
                                        <div class="card __shadow h-100">
                                            <div
                                                ...
                                                <div class="d-flex justify-content-between gap-2 align-items-center">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="text-danger no-gutter remove-address-by-modal"
                                            ...
                                            <div class="card-body">
                                                <div><span class="font-nameA"> <span
                                                            class="fw-semibold min-w-60px">{{ translate('Name') }} </span>
                                                        :&nbsp; {{ $shippingAddress['contact_person_name'] }}</span>
                                                </div>
                                                <div><span class="font-nameA"> <span
                                                            class="fw-semibold min-w-60px">{{ translate('phone') }}
                                                        </span> :&nbsp; {{ $shippingAddress['phone'] }}</span>
                                                </div>
                                                <div><span class="font-nameA"> <span
                                                            class="fw-semibold min-w-60px">{{ translate('city') }} </span>
                                                        :&nbsp; {{ $shippingAddress['city'] }}</span>
                                                </div>
                                                <div><span class="font-nameA"> <span class="fw-semibold min-w-60px">
                                                            {{ translate('zip_code') }} </span>
                                                        :&nbsp;{{ $shippingAddress['zip'] }}</span>
                                                </div>
                                                <div><span class="font-nameA"> <span
                                                            class="fw-semibold min-w-60px">{{ translate('address') }}
                                                        </span> :&nbsp;{{ $shippingAddress['address'] }}</span>
                                                </div>
                                                <div><span class="font-nameA"> <span
                                                            class="fw-semibold min-w-60px">{{ translate('country') }}
...
@push('script')
    ...
    <script>
        ...
        $('#addressUpdate').on('click', function(e) {
            ...
            if (addressAs != '' && address != '' && name != '' && zip != '' && city != '' && state != '' &&
                country != '' && phone != '') {
                $.ajaxSetup({
                    headers: {
    ...
    <script>
        function initAutocomplete() {
            var myLatLng = {
                lat: {
                    {
                        $default_location ? $default_location['lat'] : '-33.8688'
                    }
                },
                lng: {
                    {
                        $default_location ? $default_location['lng'] : '151.2195'
                    }
                }
            };
