...
<head>
  ...
  <!-- fonts & icon -->
  <link rel="stylesheet" type="text/css" href="{{URL("/")}}/resources/themes/default/public/fonts/remixicon.css">
...
@include('layouts.front-end.partials.modal._dynamic-modals')
  ...
  <!-- jquery-->
  <script src="{{URL("/")}}/resources/themes/default/public/js/jquery-3.7.0.min.js"></script>

  <script src="{{URL("/")}}/resources/themes/default/public/js/popper.min.js"></script>
  
  <script src="{{URL("/")}}/resources/themes/default/public/js/bootstrap-5.3.0.min.js"></script>
  <!-- Plugin -->
  <script src="{{URL("/")}}/resources/themes/default/public/js/plugin.js"></script>
  <!-- Main js-->
  <script src="{{URL("/")}}/resources/themes/default/public/js/main.js"></script>
      ...
      $.ajax({
          ...
          success: function (data) {
              if (data.value == 1) {
                  ...
                  $('.tooltip').html('');
                  $(`.wishlist_icon_${product_id}`).removeClass('ri-heart-3-line').addClass('ri-heart-3-fill');
                  ...
                  $('.countWishlist').html(data.count);
                  $('.countWishlist-' + product_id).text(data.product_count);
                  $(`.wishlist_icon_${product_id}`).removeClass('ri-heart-3-fill').addClass('ri-heart-3-line');
              } else {
