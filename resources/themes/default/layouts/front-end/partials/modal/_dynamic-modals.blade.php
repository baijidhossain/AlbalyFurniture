    ...
    <div class="modal-content">
      ...
      <div class="modal-body pb-5">
        <div class="text-center">
          ...
          <h6 class="font-semibold mt-3 mb-4 ">{{translate('Product_has_been_removed_from_wishlist')}}</h6>
        </div>
...
<div class="modal  fade" id="outof-stock-modal">
  <div class="modal-dialog modal-dialog-centered ">
    <div class="modal-content">
      ...
      <div class="modal-body pb-5">
        <div class="text-center">
          <img src="{{asset('public/assets/front-end/img/icons/out-of-stock.png')}}" alt="" style="width:50px;">
          <h6 class="font-semibold mt-3 mb-4" id="outof-stock-modal-message">{{translate('Out_of_stock')}}</h6>
        </div>
...
<div class="modal fade" id="add-wishlist-modal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body pb-5">
        <div class="text-center">
          <img src="{{asset('public/assets/front-end/img/icons/added-wishlist.png')}}" style="width:50px;">
          <h6 class="font-semibold mt-3 mb-4 ">{{ translate('Product_added_to_wishlist') }}</h6>
        </div>
        <div class="d-flex gap-3 justify-content-center">
          <a href="javascript:" class="btn btn-success" data-bs-dismiss="modal">
            {{ translate('Okay') }}
          </a>
        </div>
      </div>
