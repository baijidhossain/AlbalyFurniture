                          ...
                          <div class="subscription-input-section">
                              ...
                              <form action="{{ route('subscription') }}" method="post">
                                  ...
                                  <input type="text" class="subscription-input"
                                      placeholder="Enter your email address" name="subscription_email">
                                  <button type="submit" class="subscribe-btn subscribe-button"><span
                                          class="btn-text">Subscribe</span>
                                      <span class="icon">
                                  ...
                                  <ul class="menu-lists">
                                      ...
                                      <li class="list">
                                          <a href="{{ route('about-us') }}"
                                              class="menu-list">{{ translate('about_us') }}</a>
                                      </li>
                                      <li class="list">
                                          <a href="{{ route('wishlists') }}"
                                              class="menu-list">{{ translate('Wishlist') }}</a>
                                      </li>

                                      <li class="list">
                                          <a href="{{ route('contacts') }}"
                                              class="menu-list">{{ translate('contacts') }}</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                                  ...
                                  <ul class="listing">
                                      ...
                                      <li class="single-list">
                                          <a href="{{ route('refund-policy') }}"
                                              class="single">{{ translate('refund_policy') }}</a>
                                      </li>

                                      <li class="single-list">
                                          <a href="{{ route('return-policy') }}"
                                              class="single">{{ translate('return_policy') }}</a>
                                      </li>
                                      ...
                                      <li class="single-list">
                                          <a href="{{ route('contacts') }}"
                                              class="single">{{ translate('contacts') }}</a>
                                      </li>
