                ...
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        @if ($business_mode == 'multi')
                            <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link text-capitalize" href="{{route('sellers')}}">{{ translate('all_sellers')}}</a>
                            </li>
                        @endif
                        ...
                        @if ($business_mode == 'multi')
                            ...
                            @if($seller_registration)
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle text-white text-max-md-dark text-capitalize" type="button" id="dropdownMenuButton"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: .5rem">
                                            {{ translate('seller_zone')}}
                                        </button>
