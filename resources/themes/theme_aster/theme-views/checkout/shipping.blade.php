                        ...
                        <div class="card-body  px-sm-4">
                            <div class="d-flex justify-content-center mb-30">
                                <ul class="cart-step-list">
                                    ...
                                    <li class="current cursor-pointer" onclick="location.href='{{ route('checkout-details') }}'"><span><i class="bi bi-check2"></i></span> {{ translate('Shipping_Details') }}</li>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="product-quickview">
                                                                ...
                                                                <input type="hidden"
                                                                       ...
                                                                       placeholder="{{ translate('Ex') }} : 103.344322" id="longitude" value="{{$default_location?$default_location['lng']:0}}" required >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-content border-0">
                                                ...
                                                <div class="modal-body custom-scrollbar">
                                                    <div class="product-quickview">
                                                        ...
                                                        <div class="text-center {{ $shipping_addresses->count()>0 ? 'd--none':'' }}">
                                                            <img src="{{theme_asset('assets/img/svg/address.svg')}}" alt="address" class="w-25">
                                                    ...
                                                    <div class="row mb-30">
                                                        <div class="col-sm-@if(auth('customer')->check()) '6' @else '12' @endif">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="contact_person_name" id="name" class="form-control" placeholder="{{ translate('Ex') }}: Jhon Doe" {{$shipping_addresses->count()==0?'required':''}}>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                <label for="phone">{{ translate('phone') }}</label>
                                                                <input type="tel" name="phone" id="phone" class="form-control" placeholder="{{ translate('Ex') }}: +88 01000000000" {{$shipping_addresses->count()==0?'required':''}}>
                                                            </div>
                                                        </div>
                                                        @if(!auth('customer')->check())
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="email" name="email" id="email" class="form-control" placeholder="{{ translate('Ex') }}: email@domain.com" required>
                                                            </div>
                                                        </div>
                                                        @endif
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                <label for="address_type">{{ translate('Address_Type')}}</label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="city" id="city" placeholder="{{ translate('Ex') }}: Dhaka" class="form-control"  {{$shipping_addresses->count()==0?'required':''}}>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                @else
                                                                    <input type="text" class="form-control" id="zip" name="zip" placeholder="{{ translate('Ex') }}: 1216" {{$shipping_addresses->count()==0?'required':''}}>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="product-quickview">
                                                                    ...
                                                                    <input type="hidden"
                                                                           ...
                                                                           placeholder="{{ translate('Ex') }} : 103.344322" id="billing_longitude" value="{{$default_location?$default_location['lng']:0}}" required >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-content border-0" style="max-width: 500px;">
                                                    ...
                                                    <div class="modal-body custom-scrollbar">
                                                        <div class="product-quickview">
                                                            ...
                                                            <div class="text-center {{ $billing_addresses->count()>0 ? 'd--none':'' }}">
                                                                <img src="{{theme_asset('assets/img/svg/address.svg')}}" alt="address" class="w-25">
                                                                <h5 class="my-3 pt-1 text-muted">
                                                                        {{translate('no_address_is_saved')}}!
                                                                </h5>
                                                        ...
                                                        <div class="row mb-30">
                                                            <div class="col-sm-@if(auth('customer')->check()) '6' @else '12' @endif">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" name="billing_contact_person_name" id="billing_contact_person_name" class="form-control" placeholder="{{ translate('Ex') }}: Jhon Doe" {{$billing_addresses->count()==0?'required':''}}>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-3">
                                                                    <label for="billing_phone">{{ translate('phone') }}</label>
                                                                    <input type="tel" name="billing_phone" id="billing_phone" class="form-control" placeholder="{{ translate('Ex') }}: +88 01000000000" {{$billing_addresses->count()==0?'required':''}}>
                                                                </div>
                                                            </div>
                                                            @if(!auth('customer')->check())
                                                                <div class="col-sm-6">
                                                                    <div class="form-group mb-3">
                                                                        <label for="billing_contact_email">{{ translate('email') }}</label>
                                                                        <input type="email" name="billing_contact_email" id="billing_contact_email" class="form-control" placeholder="{{ translate('Ex') }}: email@domain.com" required>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" name="billing_city" id="billing_city" placeholder="{{ translate('Ex') }}: Dhaka" class="form-control"  {{$billing_addresses->count()==0?'required':''}}>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    @else
                                                                        <input type="text" class="form-control" id="billing_zip" name="billing_zip" placeholder="{{ translate('Ex') }}: 1216" {{$billing_addresses->count()==0?'required':''}}>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
