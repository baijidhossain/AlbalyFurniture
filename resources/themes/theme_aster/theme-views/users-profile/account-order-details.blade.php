                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center gap-2">
                                                                @if($detail->product && $order->payment_status == 'paid' && $detail->product->digital_product_type == 'ready_product')
                                                                    <a href="javascript:" onclick="digital_product_download('{{ route('digital-product-download', $detail->id) }}')"
                                            ...
                                            <div class="d-flex flex-column gap-3 text-dark">
                                                ...
                                                @if($order->order_type == 'default_type')
                                                    <div
                                                        ...
                                                        <div>{{\App\CPU\Helpers::currency_converter($summary['total_shipping_cost'] - ($order['is_shipping_free'] ? $order['extra_discount'] : 0))}}</div>
                                                    </div>
                                                @endif
                                                <div
                                                    class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                                    <div>{{translate('Discount_on_product')}}</div>
                                                ...
                                                @if($order->order_type != 'default_type')
                                                    <div
                                                        ...
                                                        <div>{{translate('extra_Discount')}}</div>
                                                        <div>
