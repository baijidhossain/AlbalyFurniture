                                        ...
                                        <div class="media-body">
                                            <div class="d-flex flex-column gap-1">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center gap-2 gap-sm-3">
                                                    ...
                                                    <span class="{{$supportTicket->status ==  'open' ? 'badge bg-info' : 'badge bg-danger'}} rounded-pill">{{ translate($supportTicket->status) }}</span>
                                                    <span class="badge bg-white text-dark">{{ translate($supportTicket->type) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
