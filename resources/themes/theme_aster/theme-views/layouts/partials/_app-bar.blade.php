                    ...
                    <div class="media gap-3">
                        <div class="avatar avatar-xxl overflow-hidden position-relative rounded">
                            ...
                            onerror="this.src='{{theme_asset('assets/img/image-place-holder.png')}}'"
                             loading="lazy" alt="Product" class="img-fit dark-support rounded img-fit overflow-hidden {{ $product->status == 0?'blur-section':'' }}" />
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-flex gap-3 justify-content-between align-items-end">
                                ...
                                <div class="quantity">
                                    ...
                                    @else
                                        <span class="quantity__minus cart_quantity__minus{{ $cartItem['id'] }}"  onclick="updateCartQuantity('{{ $cartItem['id'] }}','{{ $cartItem['product_id'] }}', '-{{$cartItem['quantity']}}', 'minus')">
                                            <i class="bi bi-trash3-fill text-danger fs-10"></i>
                                        </span>
                                        <input type="hidden" class="quantity__qty cart_quantity_of_{{ $cartItem['id'] }}" data-min="1" value="1"
                                            onchange="updateCartQuantity('{{ $cartItem['id'] }}','{{ $cartItem['product_id'] }}', '0')">
                                    @endif
                                </div>
                            </div>
